...
public class FeedbackController {
    ...
    public ResponseEntity<ResponseStructure<FeedbackResponse>> createfeedback(@RequestBody FeedbackRequest feedback, @PathVariable String userId, @PathVariable String movieId){
